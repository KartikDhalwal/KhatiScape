    ...
    <footer className="bg-amber-100 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <Link
                href="https://www.facebook.com/share/1Wfg3rpVRX/"
                className="text-gray-600 hover:text-black transition"
              >
                <Facebook size={20} />
              </Link>
              <Link
                href="https://www.instagram.com/khatiscape_architects_interior?igsh=MTRoMWtxMXhhbWNjOQ=="
                className="text-gray-600 hover:text-black transition"
              >
                <Instagram size={20} />
              </Link>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-600 hover:text-black">
          <p>© 2025 KhatiScape. All rights reserved.</p>
